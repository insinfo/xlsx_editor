...
var setBorder = function (lucksheetfile: any, worksheet: ExcelJS.Worksheet) {
  ...
  //获取所有的单元格边框的信息
  const borderInfoCompute: IBorderInfoCompute = getBorderInfo(lucksheetfile);
  for (let x in borderInfoCompute) {
    let border: Partial<ExcelJS.Borders> | any = {};
          ...
          if (borderType == "border-left") {
            for (let bd_r = bd_r1; bd_r <= bd_r2; bd_r++) {
              ...
              if (borderInfoCompute[bd_r + "_" + bd_c1] == null) {
                borderInfoCompute[bd_r + "_" + bd_c1] = {} as IBorderInfo;
              }
            ...
            for (let bd_r = bd_r1; bd_r <= bd_r2; bd_r++) {
              ...
              if (borderInfoCompute[bd_r + "_" + bd_c2] == null) {
                borderInfoCompute[bd_r + "_" + bd_c2] = {} as IBorderInfo;
              }
            ...
            for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c++) {
              if (borderInfoCompute[bd_r1 + "_" + bd_c] == null) {
                borderInfoCompute[bd_r1 + "_" + bd_c] = {} as IBorderInfo;
              }
            ...
            for (let bd_c = bd_c1; bd_c <= bd_c2; bd_c++) {
              if (borderInfoCompute[bd_r2 + "_" + bd_c] == null) {
                borderInfoCompute[bd_r2 + "_" + bd_c] = {} as IBorderInfo;
              }
                ...
                if (
                  ...
                  if (mc.r == bd_r) {
                    if (borderInfoCompute[bd_r + "_" + bd_c] == null) {
                      borderInfoCompute[bd_r + "_" + bd_c] = {} as IBorderInfo;
                    }
